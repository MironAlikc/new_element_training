...
@RoutePage()
class ContactsScreenTablet extends StatefulWidget {
  const ContactsScreenTablet({
    super.key,
  });

  @override
  State<ContactsScreenTablet> createState() => _ContactsScreenTabletState();
}

class _ContactsScreenTabletState extends State<ContactsScreenTablet> {
